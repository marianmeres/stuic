...
commit a YAML file at `.github/workflows/test.yml` describing _when_ to run (push / pull*request) and
\_what steps* to run on a fresh Linux VM. GitHub then shows a green ✓ / red ✗ on each commit and PR.
