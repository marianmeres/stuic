...
```svelte
<Backdrop bind:visible style="--stuic-backdrop-bg: rgb(0 0 0 / 0.8);">...</Backdrop>
```
...
```svelte
<Backdrop bind:visible class="bg-black/25">...</Backdrop>
```
...
<Backdrop bind:this={backdrop} onEscape={() => backdrop.close()}>
	<div class="m-auto p-8 bg-white rounded">Content here</div>
</Backdrop>
```
...
<Backdrop bind:visible style="--stuic-backdrop-z-index: 100;">
