	...
	colors: {
		intent: {
			primary: {
				...
				hover: "var(--color-indigo-700)",
				active: "var(--color-indigo-800)",
			},
			accent: {
		...
		role: {
			...
			single: {
				...
				ring: "color-mix(in srgb, var(--color-indigo-600) 20%, transparent)",
			},
		},
	},
};
	...
	colors: {
		intent: {
			primary: {
				DEFAULT: "var(--color-indigo-500)",
				foreground: "var(--color-white)",
				hover: "var(--color-indigo-400)",
				active: "var(--color-indigo-300)",
			},
			accent: {
		...
		role: {
			...
			single: {
				...
				ring: "color-mix(in srgb, var(--color-indigo-400) 25%, transparent)",
			},
		},
	},
};
